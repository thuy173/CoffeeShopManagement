...
public class StageManager {
    ...
    public void loadLoginStage() {
        ...
        Scene loginScene = sceneManager.loadScene("loginController.fxml",loginController);
    ...
    public void loadHomeStage() {
        ...
        HomeController homeStageController = new HomeController();
        Scene homeStage = sceneManager.loadScene("homeController.fxml", homeStageController);
...
//
    public void loadShowProduct() {
        Stage showProductStage = new Stage();
        ShowProductController showProductController = new ShowProductController();
        Scene showProductScene = sceneManager.loadScene("showProduct.fxml",showProductController);
        showProductStage.setScene(showProductScene);
        setCurrentStage(showProductStage);
        showProductController.setStage(currentStage);
        currentStage.initStyle(StageStyle.TRANSPARENT);
        showProductScene.setFill(Color.TRANSPARENT);
        showStage();
    }
    ...
    public void loadDashBoard() {
        ...
        Scene dashBoardScenne = sceneManager.loadScene("dashboardController.fxml", dashBoardController);
        dashBoardStage.setScene(dashBoardScenne);
        setCurrentStage(dashBoardStage);
        dashBoardController.setStage(dashBoardStage);
        currentStage.initStyle(StageStyle.TRANSPARENT);
        dashBoardScenne.setFill(Color.TRANSPARENT);
        showStage();
    }
